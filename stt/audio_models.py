...
class AudioModel(object):
    ...
    def get_pitch(self, speech, ctm_info, f0_list, frame_length=200, win_length=100):
        pitch_list = []
    ...
    def get_intensity(self, speech, ctm_info, energy_list, frame_length=200):
        energy_list = []
